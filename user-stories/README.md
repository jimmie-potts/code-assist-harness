...
reads, tool execution, policy, and broader multi-turn loop behavior remain unimplemented; the next
planning work is to refine the first E3 repository-context unit.
