...
**Last updated:** 2026-08-03 after PR #24 completed M1 and the M2 plan was refined.
...
| 3 | M2 - Read-only coding assistant | Current / Planned | TBD | 14 Planned stories, CAH-024 through CAH-037; see the [refined M2 plan](notes/2026-08-03-m2-read-only-assistant-planning.md) | Implement CAH-024 |
...
LLM/tool exchange, atomic provider-response admission, explicit agent loop, OpenAI mapping, and
evaluation sequence.

## Epic backlog

The epics below retain stable outcome-level ownership. M2 work across E2, E3, E4, and E8 is now
refined into CAH-024 through CAH-037; later milestone work should receive IDs only when it has
dependencies, acceptance criteria, review sizing, and validation evidence.
...
CAH-031 is the implementation-ready M2 registry kernel. It owns typed registration and dispatch for
the already-defined native read handlers only. M3 retains write and command capabilities, layered
policy, approvals, subprocess execution, network behavior, and executor isolation.
