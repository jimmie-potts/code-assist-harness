...
This is an accepted target decision. At acceptance time, no `tui/` project or Python runtime entry
point existed. CAH-002 creates the Ink shell, and CAH-003 implements child startup, supervision,
